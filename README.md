...
# Theory
## Categorical Data:-
### It is a type of data that represents groups, labels, or categories instead of numerical values. These values describe qualities or characteristics and cannot be measured numerically.
### Examples:
#### •	Gender (Male/Female)
...
## Common Operations in Categorical Data Analysis
### 1. Frequency Count ---> counts the number of occurrences of each category.
### Example:
#### Electronics → 3
#### Clothing → 3
#### Grocery → 2
### In Python this is done using:---> value_counts()

### 2. Unique Category Identification ---> used to find distinct categories present in a dataset.
### Example:
#### UPI, Card, Cash
### In Python this is done using:---> unique()
...
### 5. Role of Python in Categorical Data Analysis ---> provides powerful libraries for analyzing categorical data:
#### Library	Purpose
